...
console.log("typeof sym: ", typeof sym); //symbol,  NOT STRING
console.log("typeof sym: ", typeof sym.description); // string (foo)
...
console.log('Symbol.for("dog") sym1 === sym2: ', sym1 === sym2); //true
...
console.log('Symbol("dog") sym3 === sym4: ', sym3 === sym4); //false
